...
export const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    desc: "Combine votre capteur de distance et l'écran OLED du groupe 8D : l'écran pilote une cible mouvante lue en temps réel que vous suivez avec la main pendant quinze secondes.",
    diff: "Difficile",
  },
  {
    id: "color_zone",
